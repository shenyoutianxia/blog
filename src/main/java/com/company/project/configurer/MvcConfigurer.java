...
import com.company.project.common.interceptor.LoginInterceptor;
...
public class MvcConfigurer implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry interceptorRegistry) {
        ...
        interceptorRegistry.addInterceptor(new LoginInterceptor())
                .addPathPatterns("/**")  //会拦截所有请求  包括静态资源
                .excludePathPatterns("/","/login","/css/**", "/bootstrap-4.2.1-dist/**","/images/**","/js/**");  //放行资源
...
//    资源映射类
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry){
        registry.addResourceHandler("/avatar/**")
                .addResourceLocations("file:D:/workspace/spring-boot-api-project-seed/src/main/resources/static/avatar/");
